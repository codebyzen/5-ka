...
?>
<FORM METHOD="POST" id="addSForm" enctype="application/x-www-form-urlencoded" ACTION="<?=$_cfg['www'];?>/admin/?act=addS">
<input type="text" name="title">
<textarea style="height:200px;" name="text" id="textbox"></textarea>
</FORM>
